...
def main():
    ...
    # Checks the create user page has been loaded
    assert "Create User Page" in driver.title
    ...
    enter_text("/html/body/form/section/div/div/div/div/div/div[2]/input", fname) # First name field
    enter_text("/html/body/form/section/div/div/div/div/div/div[4]/input", lname) # last name field
    enter_text("/html/body/form/section/div/div/div/div/div/div[6]/input", email) # Email field
    enter_text("/html/body/form/section/div/div/div/div/div/div[8]/input", password) # Password field
    enter_text("/html/body/form/section/div/div/div/div/div/div[10]/input", verify_password) # Confirm password field
    ...
    driver.find_element(By.XPATH, "/html/body/div/table/tbody/tr[10]/td[7]/div/div[2]/a").click()

    # Checks the user management page has been loaded
    assert "Delete User Page" in driver.title
