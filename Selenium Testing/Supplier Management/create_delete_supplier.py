...
def main():
    ...
    # Checks the create supplier page has been loaded
    assert "Create Supplier Page" in driver.title
    ...
    enter_text("/html/body/form/section/div/div/div/div/div/div[2]/input", company) # Company field
    enter_text("/html/body/form/section/div/div/div/div/div/div[4]/input", name) # Contact name field
    enter_text("/html/body/form/section/div/div/div/div/div/div[6]/input", email) # Contact Email field
    enter_text("/html/body/form/section/div/div/div/div/div/div[7]/div[2]/input", number) # Contact Number field
    enter_text("/html/body/form/section/div/div/div/div/div/div[7]/div[4]/input", postcode) # Postcode field
    enter_text("/html/body/form/section/div/div/div/div/div/div[7]/div[6]/input",country) # Country field

    # Waits 5 seconds before continuing
    time.sleep(5)

    # Clicks the register button
    driver.find_element(By.XPATH, "/html/body/form/section/div/div/div/div/div/div[7]/button").click()
    ...
    driver.find_element(By.XPATH, "/html/body/div/table/tbody/tr[3]/td[10]/div/div[2]/a").click()

    # Checks the delete supplier page has been loaded
    assert "Delete Supplier Page" in driver.title
