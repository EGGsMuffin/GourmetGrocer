...
def main():
    ...
    driver.find_element(By.XPATH, "/html/body/div/table/tbody/tr[2]/td[4]/div/div[1]/a").click()

    # Checks the edit category page has been loaded
    assert "Edit Category Page" in driver.title
    ...
    name = "Clothing"
    description = "Apparel is for wearing"
    enter_text("/html/body/form/section/div/div/div/div/div/div[4]/input", name) # category name field
