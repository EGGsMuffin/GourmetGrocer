...
def main():
    ...
    driver.find_element(By.XPATH, "/html/body/div/table/tbody/tr[1]/td[5]/div/div[1]/a").click()

    # Checks the edit role page has been loaded
    assert "Edit Roles Page" in driver.title
    ...
    name = "Test"
    enter_text("/html/body/form/section/div/div/div/div/div/div[4]/input", name) # Role name field
