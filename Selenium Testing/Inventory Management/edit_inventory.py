...
def main():
    ...
    driver.find_element(By.XPATH, "/html/body/div/table/tbody/tr[1]/td[4]/div/div[1]/a").click()

    # Checks the edit inventory page has been loaded
    assert "Edit Inventory Page" in driver.title
    ...
    enter_text("/html/body/form/section/div/div/div/div/div/div[4]/input", name) # Name field
    enter_text("/html/body/form/section/div/div/div/div/div/div[6]/input", description) # Description field
    enter_text("/html/body/form/section/div/div/div/div/div/div[8]/input", image) # Image field
    ...
    # Enters text into the update form
    name = "Chair"
    description = "Can sit one person"
    image = "https://www.daals.co.uk/cdn/shop/products/DCH-2159-TAUPE-BOUCLE_main.jpg?v=1677852153"
    enter_text("/html/body/form/section/div/div/div/div/div/div[4]/input", name) # Name field
    enter_text("/html/body/form/section/div/div/div/div/div/div[6]/input", description) # Description field
    enter_text("/html/body/form/section/div/div/div/div/div/div[8]/input", image) # Image field
